...
class DatePlaceViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = self.placetableview.dequeueReusableCellWithIdentifier("placecell")! as UITableViewCell
        cell.textLabel?.text = "哇哈哈"
        return cell
    }
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        debugPrint(indexPath.row)
        let cell = placetableview.cellForRowAtIndexPath(indexPath)! as UITableViewCell
