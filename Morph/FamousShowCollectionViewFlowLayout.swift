//
//  FamousShowCollectionViewFlowLayout.swift
//  Morph
//
...
class FamousShowCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for i in 0..<tempArray.count {
            ...
            layoutAttri.transform = transformScale.rotated(by: CGFloat(M_PI_4) / 4)
